...
//切换到各个界面
    connect(&this->widgetmainIns,SIGNAL(MeasureInsDisplaysignal(int)),this,SLOT(MeasureInsDisplayslot(int)));
    connect(&this->widgetmainIns,SIGNAL(ConstantInsDisplaysignal(int)),this,SLOT(ConstantInsDisplayslot(int)));
    connect(&this->widgetmainIns,SIGNAL(controlInsDisplaysignal(int)),this,SLOT(controlInsDisplayslot(int)));
    connect(&this->widgetmainIns,SIGNAL(sysconfigDisplaysignal()),this,SLOT(sysconfigDisplayslot()));
...
//    connect(&widgetmainIns,SIGNAL(PowerDownStampSetupsignal()),this,SLOT(PowerDownStampSetupslot()));
  ...
  //  connect(&this->widgetmainIns,SIGNAL(nointersignal(int)),&nointerwarningIns,SLOT(nointerslot(int)));
    ...
    //login
//    connect(&widgetmainIns,SIGNAL(powerusrloginDisplaysignal()),this,SLOT(powerusrloginDisplayslot()));
...
//    connect(&poweruserloginIns,SIGNAL(usrloginsignal()),&widgetmainIns,SLOT(usrloginslot()));
//    connect(&poweruserloginIns,SIGNAL(usrlogoutsignal()),&widgetmainIns,SLOT(usrlogoutslot()));
...
//    connect(&powerusrmodifypasswdIns,SIGNAL(modifypasswdsignal()),this,SLOT(confirmsaveusrinfoslot()));
  ...
  //  connect(&widgetmainIns,SIGNAL(testsndERRMSGsignal()),&commuIns,SLOT(testsndERRMSGslot()));
    ...
    //上位机 控制
//    connect(&modbustcpserverInsA,SIGNAL(remote_control_info(int,int,int,int)),&commuIns,SLOT(remotemsgcontrol_tocom(int,int,int,int)));
//    connect(&modbustcpserverInsA,SIGNAL(remote_PreReadConstantSignal(int)),&commuIns,SLOT(remote_PreReadConstantSlot(int)));
//    connect(&commuIns,SIGNAL(remoteSETTINGrcv_result(int,int,u8,u32*)),&modbustcpserverInsA,SLOT(handle_remoteSETTING_rcv_result_slot(int,int,u8,u32*)));

   // connect(&modbustcpserverInsA,SIGNAL(remote_WriteSetting_signal(int,int,int,int)),&commuIns,SLOT(remote_WriteSettingSlot(int,int,int,int)));
...
//    connect(&modbustcpserverInsB,SIGNAL(remote_switch_local_remote_signal(int)),&widgetmainIns,SLOT(remoteswitch_local_remote_slot(int)));

//    connect(&modbustcpserverInsB,SIGNAL(remote_constant_info(int,int,int,unsigned int*,unsigned char)),&commuIns,SLOT(remoteWriteConstantInfo(int,int,int,unsigned int*,unsigned char)));

//    connect(&modbustcpserverInsB,SIGNAL(remote_control_info(int,int,int,int)),&commuIns,SLOT(remotemsgcontrol_tocom(int,int,int,int)));

//    connect(&modbustcpserverInsB,SIGNAL(remote_PreReadConstantSignal(int)),&commuIns,SLOT(remote_PreReadConstantSlot(int)));
//    connect(&commuIns,SIGNAL(remoteSETTINGrcv_result(int,int,u8,u32*)),&modbustcpserverInsB,SLOT(handle_remoteSETTING_rcv_result_slot(int,int,u8,u32*)));

   // connect(&modbustcpserverInsB,SIGNAL(remote_WriteSetting_signal(int,int,int,int)),&commuIns,SLOT(remote_WriteSettingSlot(int,int,int,int)));

//    connect(&commuIns,SIGNAL(remotesnd_result(int,int,int,int)),&widgetmainIns,SLOT(remotesnd_result_slot(int,int,int,int)));
//    connect(&commuIns,SIGNAL(remotesnd_result(int,int,int,int)),&modbustcpserverInsA,SLOT(updateSndRltHoldRegControlStatusSlot(int,int,int,int)));
//    connect(&commuIns,SIGNAL(remotesnd_result(int,int,int,int)),&modbustcpserverInsB,SLOT(updateSndRltHoldRegControlStatusSlot(int,int,int,int)));

//    connect(&commuIns,SIGNAL(remotercv_result(int,int,int,int)),&widgetmainIns,SLOT(remotercv_result_slot(int,int,int,int)));
//    connect(&commuIns,SIGNAL(remotercv_result(int,int,int,int)),&modbustcpserverInsA,SLOT(updateRcvRltHoldRegControlStatusSlot(int,int,int,int)));
//    connect(&commuIns,SIGNAL(remotercv_result(int,int,int,int)),&modbustcpserverInsB,SLOT(updateRcvRltHoldRegControlStatusSlot(int,int,int,int)));

//    connect(&commuIns,SIGNAL(remoteSETTINGrcv_result(int,int,u8,u32*)),&widgetmainIns,SLOT(remoteSETTINGrcvResultSlot(int,int,u8,u32*)));
...
void centralCtl::MeasureInsDisplayslot(int LogicAddr)
{
    this->measureIns.EnterProcess(LogicAddr);
    this->measureIns.move(0,0);
    this->measureIns.show();
}

void centralCtl::ConstantInsDisplayslot(int LogicAddr)
{
    this->constantIns.EnterProcess(LogicAddr);
    this->constantIns.move(0,0);
    this->constantIns.show();
}

void centralCtl::controlInsDisplayslot(int LogicAddr)
{
    this->controlIns.EnterProcess(LogicAddr);
    this->controlIns.move((800-400)/2,(480-300)/2);
...
void centralCtl::powerusrloginDisplayslot()
{
//    this->poweruserloginIns.loginInit();
//    this->poweruserloginIns.move((800-540)/2,(480-374)/2);
//    this->poweruserloginIns.show();
}
...
//        srcstr = QString::number(usrlistdata.operaterlvl.at(i).passwd);
    ...
    doc.SaveFile("/substation/configfiles/usrinfo/usrpwdlist.xml");
}
...
#else
    XMLError ret = doc.LoadFile( "/substation/configfiles/sysconfigtest.xml" );
#endif
    if(ret != XML_SUCCESS)
    {
...
#else
    XMLError ret = structdoc.LoadFile( "/substation/configfiles/sysStruct.xml" );
#endif
    if(ret != XML_SUCCESS)
    {
...
#else
    XMLError ret = doc.LoadFile( "/substation/configfiles/protocollist.xml" );
#endif
    if(ret != XML_SUCCESS)
        return;
    else
...
#else
    char path[100] = "/substation/configfiles/";
#endif
...
#else
    XMLError ret = doc.LoadFile("/substation/configfiles/usrinfo/usrpwdlist.xml");
#endif
    if(ret != XML_SUCCESS)
    {
