...
//    poweruserlogin poweruserloginIns;
//    powerusrmanager powerusrmanagerIns;
//    powerusrmodifypasswd powerusrmodifypasswdIns;
...
public slots:
    void MeasureInsDisplayslot(int LogicAddr);
    void ConstantInsDisplayslot(int LogicAddr);
    void controlInsDisplayslot(int LogicAddr);
